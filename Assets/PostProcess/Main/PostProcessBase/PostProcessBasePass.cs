...
namespace TK.Rendering.PostProcess
{
    ...
    public abstract class PostProcessBasePass<T> : ScriptableRenderPass where T : VolumeComponent
    {
        ...
        public PostProcessBasePass(RenderPassEvent renderPassEvent, Shader shader)
        {
